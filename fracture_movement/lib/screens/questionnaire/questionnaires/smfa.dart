...
final smfaQuestionnaire = Questionnaire(
  ...
  questions: const [
    Question(
      ...
      text: 'Hur svårt hade du att sätta dig i, och resa dig ur en låg stol?',
      type: QuestionType.singleChoice,
      options: difficultyOptions,
    ),
    Question(
      text: 'Hur svårt hade du att öppna medicinförpackningar eller burkar?',
      type: QuestionType.singleChoice,
      options: difficultyOptions,
    ),
    Question(
    ...
    Question(
      ...
      text: 'Svårigheter att använda den/de kroppsdelar som du sedan skadade?',
      type: QuestionType.singleChoice,
    ...
    Question(
      text: 'Svårigheter att ägna dig åt fritidsaktiviteter och/eller motion?',
      type: QuestionType.singleChoice,
      options: annoyanceOptions,
    ),
    Question(
